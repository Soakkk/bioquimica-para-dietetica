...
export default function IntegratedReview({ onEarn }: { onEarn: (amount: number) => void }) {
  ...
  if (stage === "theory") return <div className="review-theory-sheet">
    ...
    <div className="review-theory-footer"><button className="primary" onClick={startQuiz}>Empezar los {route.questions.length} ejercicios →</button></div>
  </div>;
